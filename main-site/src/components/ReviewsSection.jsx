...
const ReviewsSection = () => {
  ...
  useEffect(() => {
    async function loadData() {
      const posts = await fetchPostsByCategory('reviews', 8);
      setArticles(posts);
      setLoading(false);
    }
    loadData();
      ...
      <section className="py-12 md:py-20 bg-brand-bg relative overflow-hidden border-t border-white/5">
        <div className="container-custom">
          <div className="flex items-center gap-4 mb-10 md:mb-12">
            ...
            <div className="w-40 md:w-56 h-8 md:h-10 bg-white/5 rounded-md animate-pulse" />
          </div>
      ...
      <div className="container-custom">
        ...
        <div className="flex items-center justify-between mb-10 md:mb-12 px-1 md:px-0">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <h2 className="text-white text-xl md:text-3xl font-black uppercase tracking-tighter">ViewSpree Reviews</h2>
          </div>
          <button 
